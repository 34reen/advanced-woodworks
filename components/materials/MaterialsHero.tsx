...
export default function MaterialsHero() {
  return (
    <section className="relative min-h-[76vh] overflow-hidden bg-stone-950 text-white">
      <Image
        src="/images/workshop.jpg"
        alt="Premium timber and boards prepared in the Advanced Woodworks workshop"
        fill
        priority
        sizes="100vw"
      ...
      <div className="relative mx-auto flex min-h-[76vh] max-w-7xl items-center px-6 py-20">
        <div className="max-w-3xl">
          <p className="text-sm font-semibold uppercase tracking-[4px] text-amber-300">
            Materials Store
          </p>
          <h1 className="mt-5 text-5xl font-bold leading-tight md:text-7xl">
            Premium Wood Materials For Refined Builds
          </h1>
          <p className="mt-6 max-w-2xl text-lg leading-relaxed text-stone-100 md:text-xl">
            Shop selected hardwoods, boards, planks, and finishing materials
            used by the Advanced Woodworks workshop.
          </p>
          <div className="mt-9 flex flex-col gap-4 sm:flex-row">
            <Link
              href="#materials-store"
